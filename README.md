...
<p align="center">
  <a href="https://github.com/ELHADANITAHA/Scalingo-TP">🔗 Accéder au dépôt GitHub Scalingo-TP</a>
</p>
...
Add your screenshots here to demonstrate the security and correct operation of the infrastructure:

### 1. Trivy Dashboard (SAST)
...
## ⚖️ Exercise 1 - Infrastructure Summary & Security Hardening
...
- **Docker** runs:
  ...
  - **NGINX Reverse Proxy** (HTTPS, load balancing, traffic forwarding)
  - **WAF (ModSecurity CRS):** First line of defense, filtering and blocking web attacks
  - **SAST (Trivy):** Security scanner for images and files
  - **Ansible:** Automation and hardening orchestrator
...
```
- **WAF**: Filters and blocks malicious traffic (OWASP Top 10, CVEs, XSS, SQL injection, etc.)
- **NGINX**: Terminates HTTPS, load balances, and forwards only clean traffic
